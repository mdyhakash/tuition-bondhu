...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "Found an amazing physics tutor through Tuition Bondhu. My grades improved from C to A+ in just 3 months!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "The programming tutors here are exceptional. Got a job at a tech company thanks to the skills I learned.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "My daughter's math tutor is so patient and caring. She actually enjoys studying now!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Online chemistry classes were perfect during lockdown. Scored 95% in my board exams!",
...
const sponsors = [
  ...
  { name: "Grameenphone", logo: "/placeholder-chm4z.png", type: "Sponsor" },
  {
    ...
    logo: "/dutch-bangla-bank-logo.png",
    type: "Partner",
  },
  { name: "Robi", logo: "/generic-telecom-logo.png", type: "Sponsor" },
  {
    name: "City Bank",
    logo: "/city-bank-bangladesh-logo.png",
    type: "Partner",
  },
  {
    name: "Banglalink",
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                Find Your Perfect <span className="text-primary">Tutor</span> in
                Bangladesh
              </motion.h1>
              ...
              >
                Connect with qualified tutors across Bangladesh. Home tutoring,
                online classes, and group sessions - all in one platform.
              </motion.p>
      ...
      <section className="py-12 bg-muted/50">
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-sm text-muted-foreground mb-6">We featured in</p>
              ...
              {featuredInLogos.map((media, index) => (
                ...
                >
                  <img
                    src={media.logo}
                    alt={media.name}
                    className="h-16 md:h-28 object-contain opacity-60 hover:opacity-100 transition-opacity"
                  />
                </motion.div>
              ))}
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We make finding the perfect tutor simple, safe, and affordable for
            ...
            {[
              {
                ...
                description:
                  "All tutors undergo background verification and skill assessment",
                color: "primary",
              },
              {
                icon: MapPin,
                title: "Local & Online",
                description:
                  "Find tutors in your area or learn online from anywhere",
                color: "accent",
              },
              {
                icon: Clock,
              ...
              },
              {
                ...
                title: "All Subjects",
                description:
                  "From primary to university level, all subjects covered",
                color: "chart-5",
              },
              {
                icon: CheckCircle,
      ...
      <section className="py-16 md:py-24 bg-muted">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Real stories from students and parents who found success through
              Tuition Bondhu.
            </p>
          </motion.div>
                    ...
                    >
                      <Card className="bg-card border-border shadow-lg">
                        <CardContent className="p-8 text-center">
                          ...
                          <p className="text-lg text-card-foreground mb-6 italic">
                            "{testimonial.comment}"
                          </p>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Trusted by leading organizations across Bangladesh to deliver
              quality education.
            </p>
          </motion.div>
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="overflow-hidden">
              ...
              >
                {Array.from({ length: Math.ceil(sponsors.length / 3) }).map(
                  (_, slideIndex) => (
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8 text-lg">
              Join thousands of students who have found their perfect tutor on
              Tuition Bondhu.
            </p>
      ...
      <footer className="bg-muted py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Connecting students and tutors across Bangladesh for better
                education.
              </p>
            </div>
          ...
          <div className="border-t border-border mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>
              &copy; 2025 <a href="/">Tuition Bondhu.</a>
            </p>
          </div>
        </div>
      </footer>
